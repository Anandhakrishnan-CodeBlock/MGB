...
<head>
	...
	<title>MPB - Employe Details Update</title>
          ...
          <span class="align-middle">MGB</span>
              ...
              <i class="align-middle" data-feather="user"></i> <span class="align-middle">Employe</span>
						...
						<ul id="layouts" class="sidebar-dropdown list-unstyled collapse ">
							...
							<li class="sidebar-item active"><a class="sidebar-link" href="2_emp_update.php">Update</a></li>
          ...
          <i class="align-self-center" data-feather="menu"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Edit Employe Register</h1>
											...
											<form id="emp_update" method="post">
                                                <div class="form-row">
													<div class="form-group col-md-6">
														<label for="inputFirstName">Employe No</label>
														<input type="text" class="form-control" id="empid" placeholder="Employe No">
													</div>
