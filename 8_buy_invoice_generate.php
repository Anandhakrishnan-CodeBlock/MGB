...
<head>
	...
	<title>MPB - Create Invoice</title>
              ...
              <i class="align-middle" data-feather="grid"></i> <span class="align-middle">Raw Meterial</span>
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul id="maps" class="sidebar-dropdown list-unstyled collapse ">
							...
							<li class="sidebar-item active"><a class="sidebar-link" href="8_buy_invoice_generate.php">Create Invoice</a></li>
									...
									<div class="card-body">
											<form id="bill_reg" name="bill_reg">
												<div class="form-row">
													...
													<div class="form-group col-md-4">
														<label for="date">Invoice No</label>
														 <input type="text" class="form-control" id="inid" placeholder="Invoice No" pattern="[0-9]" required>
													</div>
													<div class="form-group col-md-4">
                                                ...
                                                <div class="form-group col-md-4">
													...
													<input type="number" class="form-control" id="weight" placeholder="Weight" pattern="[0-9]" title="Please enter weight" minlength="1" step="any"  required>
												</div>
												<div class="form-group col-md-4">
													<label for="inputAddress">Price (Ton)</label>
													<input type="number" class="form-control" id="price" placeholder="Price" pattern="[0-9]" title="Please enter price" minlength="1" step="any" required>
												</div>
                                                <div class="form-group col-md-4">
													<label for="inputAddress">Total Amount</label>
													<input type="number" class="form-control" id="tamount" placeholder="Total Amount" pattern="[0-9]" title="Please enter amount" minlength="1" step="any" required>
												</div>
                                                <div class="form-group col-md-3">
													<label for="inputAddress">GST</label>
													<input type="number" class="form-control" id="gst" placeholder="GST" pattern="[0-9]" title="Please enter gst" minlength="1" step="any" required>
												</div>
												<div class="form-group col-md-3">
													<label for="inputAddress">SGST</label>
													<input type="number" class="form-control" id="sgst" placeholder="SGST" pattern="[0-9]" title="Please enter sgst" minlength="1" step="any" required disabled>
												</div>
												<div class="form-group col-md-3">
													<label for="inputAddress">CGST</label>
													<input type="number" class="form-control" id="cgst" placeholder="CGST" pattern="[0-9]" title="Please enter cgst" minlength="1" step="any" required disabled>
												</div>
												<div class="form-group col-md-3">
													<label for="inputAddress">Total GST</label>
													<input type="number" class="form-control" id="tgst" placeholder="Total GST" pattern="[0-9]" title="Please enter cgst" minlength="1" step="any" required>
												</div>
                                                </div>
                                                <div class="form-row">
													<div class="form-group col-md-3">
													<label for="inputAddress">Total Amount + GST</label>
													<input type="number" class="form-control" id="total" placeholder="Total" pattern="[0-9]" title="Please enter payed" minlength="1" step="any" required>
												    </div>
													<div class="form-group col-md-3">
													<label for="inputAddress">Round Off</label>
													<input type="number" class="form-control" id="roundoff" placeholder="Rounoff" pattern="[0-9]" title="Roundoff value" minlength="1" step="any" required>
												    </div>
                                                    <div class="form-group col-md-3">
													<label for="inputAddress">Payed</label>
													<input type="number" class="form-control" id="payed" placeholder="Payed" pattern="[0-9]" title="Please enter payed" minlength="1" step="any" required>
												    </div>
													<div class="form-group col-md-3">
												...
												<div class="form-row">
													...
													<label for="inputAddress">Payment Type</label>											
            											...
            											<input class="form-check-input" type="radio" name="pay_type" value="Advance" name="radios-example" required>
            											<span class="form-check-label">
              											Advance
            											</span>
          												</label>
														<label class="form-check">
            											<input class="form-check-input" type="radio" name="pay_type" value="Cash On Deliver" name="radios-example" required>
														<span class="form-check-label">
														Cash On Deliver
            											</span>
          												</label>
													...
													<div class="form-group col-md-3">
													<label for="inputAddress">Balance Amount</label>
													    <input type="text" class="form-control" id="balance" placeholder="balance" required disabled>
												    </div>
												</div>
