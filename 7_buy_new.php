...
<head>
	...
	<title>MPB - Buyers Registration</title>
              ...
              <i class="align-middle" data-feather="grid"></i> <span class="align-middle">Raw Meterial</span>
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul id="maps" class="sidebar-dropdown list-unstyled collapse ">
							<li class="sidebar-item active"><a class="sidebar-link" href="7_buy_new.php">Register</a></li>
          ...
          <i class="align-self-center" data-feather="menu"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Buyers</h1>

					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title mb-0">Enter Buyers Details</h5>
								</div>
								<div class="card-body">
									...
									<div class="card-body">
											<form id="buy_reg">
												<div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="gstno" placeholder="GST NO" maxlength="15" pattern="[0-9]{15,15}" title="Please use only alphabet, Character length of 15"required><br>
